...
* util/docker_build.sh -e CONVERT_TO=elite_pi
* MAKEFLAGS="EXTRAFLAGS=-DMASTER_LEFT" util/docker_build.sh sofle:rgb_markwkm
* MAKEFLAGS="EXTRAFLAGS=-DMASTER_RIGHT" util/docker_build.sh sofle:rgb_markwkm
